...
long int code;
class trvelcode{
	public: virtual int gcode(){cout<<"";
	}
	
};
class persdetails:private trvelcode  //class for collecting the personal details
{
  int trvlcode;
  int  age[20];
  char name[20][20];
  ...
  friend ostream& operator <<(ostream& out,persdetails per)
  {
cout<<"\n\n\t:::::::::::::::::::::: PERSONAL DETAILS ::::::::::::::::::::::\n";
  cout<<"\t\t\t\t~~~~~~~~~~~~~~\n";
return out;
...
class travdetails:public trvelcode  //class which holds the travel details
{
  int trvtcode;
  int day;
  int month;
  ...
  do
  {
    ...
    switch(opt)
    {
      ...
      case 3://b
	     ...
	     cin>>day;
	     //b(59,7);   //to create a paricular format for entry
	     cout<<"/";
	     cin>>month;
	     //b(62,7);
	     cout<<"/";
...
{
  ofstream ofl2("temp1.txt");
  if(!ofl2)
  cout<<"Error While Opening File";
  ifstream ifl4("personal.txt");
  if(!ifl4)
  cout<<"Error While Opening File";
...
void editt(int c)  //to edit travdetails
{
  ...
  if(!ofl2)
  cout<<"Error While Opening File";
  ifstream ifl4("TravelDetails.txt");
  if(!ifl4)
  cout<<"Error While Opening File";
...
void deletion(int c)  //common delete func()
{
  ...
  while(!ifl4.eof())
  {
    if(pob.gcode()!=c)
    {
      ofl9.write((char*)&pob,sizeof(pob));
    }
    ifl4.read((char*)&pob,sizeof(pob));
  }
  ofl9.close();
  ifl4.close();
  !remove("personal.txt");
  rename("tempx.txt","personal.txt");
  ofstream ofl3("temp2.txt");
  if(!ofl3)
  cout<<"\nError While Opening File";
  ifstream ifl5("TravelDetails.txt");
  if(!ifl5)
  cout<<"\nError While Opening File";
  ...
  ifl5.close();
  !remove("TravelDetails.txt");
  rename("temp2.txt","TravelDetails.txt");
  cout<<"\n\n\t\tDeletion Completed!";
  getch();
}
...
int main()
{
  ...
  //b
  cout<<"\n================================================================================\n";
  cout<<"\n\t\tWELCOME TO MINIPROJECT ON C++\n";
  cout<<"\t\tTHIS IS A TRAVEL AGENCY SOFTWARE\n";
  cout<<"\n================================================================================\n";
  ifstream fl("INITIALL.txt"); //initialisation of code
  if(!fl)
  cout<<"\nError";
    ...
    switch(opt)
    {
      case 1:do
		 ...
		 case 1:code++;
		 {
			cout<<pob;
			pob.p_input(code);
			ofstream ofl("personal.txt",ios::app);
			if(!ofl)
		 ...
		 case 2:
		 {
			cout<<tob;
		 tob.t_input(code);
			ofstream ofl1("TravelDetails.txt",ios::app);
			if(!ofl1)
			cout<<"\n\n\t\tSorry.The File Cannot Be Opened For Writing"<<endl;
      ...
      case 2://b
		 ...
		 case 2:
		 {
		 ifstream ifl1("TravelDetails.txt");
			if(!ifl1)
			cout<<"\nError";
			ifl1.read((char*)&tob,sizeof(tob));
			while(!ifl1.eof())
			{
			  if(tob.gcode()==acceptcode)
			  {
			    break;
			  }
			  ifl1.read((char*)&tob,sizeof(tob));
		 ...
		 ifstream ifl3("personal.txt");
			...
			ifstream ifl2("TravelDetails.txt");
			if(!ifl2)
			cout<<"\nError";
	     ...
	     break;
      case 3:ofstream fil("INITIALL.txt"); //storing code value
	     if(!fil)
	     cout<<"\nError";
